    ...
    <div className="space-y-6 max-w-2xl mx-auto pb-12">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="dark:text-gray-400 text-gray-500 text-sm">Add a new skill to your portfolio</p>
        </div>
      </div>
      ...
      <div className="glass-card p-6 sm:p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-4 border-t border-[var(--border-color)]">
            <Link href="/admin/skills" className="btn-secondary px-6">{t('common.cancel')}</Link>
